...
<head>
    ...
    {{-- SEO Meta Tags - These will be overridden by Inertia's <Head> on a per-page basis --}}
    ...
    <meta property="og:image" content="{{ url('/frank-social-card.png') }}"> {{-- Create a 1200x630px image for social sharing --}}
    ...
    <meta name="twitter:image" content="{{ url('/frank-social-card.png') }}"> {{-- Use the same image as Open Graph --}}

    {{-- The title will be dynamically set by Inertia's <Head> component --}}
